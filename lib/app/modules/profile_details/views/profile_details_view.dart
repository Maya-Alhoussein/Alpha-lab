                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Text(controller.Model.firstName!,
                              style: TextStyle(
                      ...
                      Row(
                        children: [
                          ...
                          Text(controller.Model.lastName!,
                              style: TextStyle(
                                  fontSize: 16.sp, color: Colors.black)),
                        ],
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(controller.Model.phoneNumber!,
                              style: TextStyle(
                                  fontSize: 16.sp, color: Colors.black)),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          Text('Address : ',
                              style: TextStyle(
                                  fontSize: 16.sp,
                                  fontWeight: FontWeight.w900)),
                          Text(controller.Model.addressId.toString(),
                              style: TextStyle(
                                  fontSize: 16.sp, color: Colors.black)),
                        ],
                      )
